...
import DataDiagram from '@/features/dataDiagram/dataDiagram'; 
import { fetchDataFromJson } from '@/utils/resultsUtils';
import { formatCellValue } from '@/utils/resultsParser';

// Define the type data, the types here should match the types in the local env which should match the backend.
interface Data {
  Apps: string | null;
  IP: string;
  Hostname: string;
